...
export default function OrderCard(props) {
    return (
        <div
            className={`${regularPoppins.className} flex flex-col bg-[#fbf8f4] min-h-[300px] w-[325px] m-4 border border-black rounded-xl p-3`}
        >
            <div>
            ...
            <div className="justify-self-end">
                ...
                <div>
                    ...
                    <div className={`${semiBoldPoppins.className} text-center text-[#909090]`}>{props.data.status}</div>
                </div>
            </div>
        </div>
    );
